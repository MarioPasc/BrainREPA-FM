...
printf '=== BrainREPA-FM session resume ===\n'
printf 'pwd:  %s\n' "$PWD"
printf 'date: %s\n\n' "$(date -Iseconds)"
...
printf '\n%s\n' '--- key reference paths ---'
printf '%s\n' '  proposal: /media/mpascual/Sandisk2TB/research/brainrepa_fm/docs/proposal.md'
printf '%s\n' '  checks:   /media/mpascual/Sandisk2TB/research/brainrepa_fm/docs/checks/'
